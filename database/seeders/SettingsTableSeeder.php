    ...
    public function run(): void
    {
        ...
        $settings = [
            ...
            [
                ...
                'category' => 'security',
                'type' => 'boolean',
                'description' => 'Require users to login with 2FA (forces every user with admin access to enrol)',
                'created_by' => null,
                'updated_by' => null,
            ],
            [
                'key' => '2FA_required_for_roles',
                'value' => '',
                'category' => 'security',
                'type' => 'string',
                'description' => 'Comma-separated role names that must enrol in 2FA (e.g. "owner,admin"). Empty = no role-level enforcement (still subject to 2FA_required).',
                'created_by' => null,
                'updated_by' => null,
            ],
            [
                ...
                'category' => 'security',
                'type' => 'string',
                'description' => 'Allowed 2FA method(s): totp | email | both',
                'created_by' => null,
                'updated_by' => null,
            ],
            [
                'key' => '2FA_email_code_ttl',
                'value' => '10',
                'category' => 'security',
                'type' => 'integer',
                'description' => 'How many minutes an email-OTP code stays valid',
                'created_by' => null,
                'updated_by' => null,
            ],
            [
